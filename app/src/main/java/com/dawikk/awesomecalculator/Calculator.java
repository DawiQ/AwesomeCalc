...
public class Calculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn0 = findViewById( R.id.button30 );
        Btn1 = findViewById( R.id.button26 );
        Btn2 = findViewById( R.id.button27 );
        Btn3 = findViewById( R.id.button28 );
        ...
        BtnMC = findViewById( R.id.button10 );
        BtnMR = findViewById( R.id.button13 );
        BtnMplus = findViewById( R.id.button11 );
        BtnMminus = findViewById( R.id.button12 );
        BtnC = findViewById( R.id.button14 );
        BtnPlusMinusBtn = findViewById( R.id.button15 );
        BtnDivide = findViewById( R.id.button16 );
        BtnMultiply = findViewById( R.id.button17 );
        BtnMinus = findViewById( R.id.button21 );
        BtnPlus = findViewById( R.id.button25 );
        BtnEquals = findViewById( R.id.button29 );
        BtnDot = findViewById( R.id.button31 );
